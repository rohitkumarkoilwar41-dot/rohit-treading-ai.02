...
def get_live_price(pair_name):
    try:
        ...
        if pair_name in PAIRS:
            t = PAIRS[pair_name][0] # FIXED: String ticker extract kar liya tuple se taaki yfinance crash na ho
...
if st.button("START ANALYSIS"):
    ...
    # FIXED: Handling tuple extraction safely for string formatting
