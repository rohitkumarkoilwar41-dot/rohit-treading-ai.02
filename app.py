...
if st.button("START ANALYSIS"):
    ...
    if liq_bull: score+=12; reasons.append(f"Liquidity Sweep Bullish - EQL {eql_level:.2f} Sweep + Reclaim (Stop Hunt)")
    if liq_bear: score-=12; reasons.append(f"Liquidity Sweep Bearish - EQH {eqh_level:.2f} Sweep + Reject (Stop Hunt)")
