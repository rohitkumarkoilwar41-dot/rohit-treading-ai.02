...
if st.button("START ANALYSIS"):
    ...
    # ### DATA SAVE CALL - Yaha dala - Metric se pehle ###
    ...
    if os.path.exists("trading_history.csv"):
        ...
        st.download_button("📥 CSV Download", data=df_hist.to_csv(index=False), file_name="trading_history.csv", mime="text/csv")
