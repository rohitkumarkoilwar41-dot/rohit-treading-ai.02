...
# --- 🛰️ CORE SMC ENGINE (ALL 15 RULES MATCHED) ---
def core_janta_engine(pair_key, tf_val):
    try:
        ...
        # Rule 11 (Fibonacci Matrix - DISCOUNT vs PREMIUM)
        ...
        in_golden_pocket = fib_618 <= last <= fib_50
        ...
        # Rule 12 (London 1:30 PM Session Volume Filter)
        london_active = datetime.now().hour >= 13

        # Core Signals [ source: 1 ]
        ...
        # Liquidity Sweep Engine Fixed Variables [ source: 1 ]
